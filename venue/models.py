...
class VenuePage(Page):
    ...
    class Meta:  # noqa 
        verbose_name = "Venu Page"
        verbose_name_plural = "Venue Pages"



class VenueLoginPage(Page):
    """Venue login page class."""

    template = "venue/login.html"
    ...
    class Meta:  # noqa 
        verbose_name = "Venu Login Page"
        verbose_name_plural = "Venue Login Pages"


class MemberProfilePage(Page):
    """Venue login page class."""

    template = "venue/memberprofile.html"
    ...
    class Meta:  # noqa 
        ...
        verbose_name_plural = "Member Pages"


class MenuDiaplay(Page):
    """Menu Display page class."""

    template = "venue/menue-display.html"
    ...
    class Meta:  # noqa 
        verbose_name = "Menue Page"
        verbose_name_plural = "Menue Pages"
