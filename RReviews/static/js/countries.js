...
var country_arr = new Array("Australia","Afghanistan", "Albania", "Algeria", "American Samoa", "Angola", "Anguilla", "Antartica", "Antigua and Barbuda", "Argentina", "Armenia", "Aruba", "Ashmore and Cartier Island",  "Austria", "Azerbaijan", "Bahamas", "Bahrain", "Bangladesh", "Barbados", "Belarus", "Belgium", "Belize", "Benin", "Bermuda", "Bhutan", "Bolivia", "Bosnia and Herzegovina", "Botswana", "Brazil", "British Virgin Islands", "Brunei", "Bulgaria", "Burkina Faso", "Burma", "Burundi", "Cambodia", "Cameroon", "Canada", "Cape Verde", "Cayman Islands", "Central African Republic", "Chad", "Chile", "China", "Christmas Island", "Clipperton Island", "Cocos (Keeling) Islands", "Colombia", "Comoros", "Congo, Democratic Republic of the", "Congo, Republic of the", "Cook Islands", "Costa Rica", "Cote d'Ivoire", "Croatia", "Cuba", "Cyprus", "Czeck Republic", "Denmark", "Djibouti", "Dominica", "Dominican Republic", "Ecuador", "Egypt", "El Salvador", "Equatorial Guinea", "Eritrea", "Estonia", "Ethiopia", "Europa Island", "Falkland Islands (Islas Malvinas)", "Faroe Islands", "Fiji", "Finland", "France", "French Guiana", "French Polynesia", "French Southern and Antarctic Lands", "Gabon", "Gambia, The", "Gaza Strip", "Georgia", "Germany", "Ghana", "Gibraltar", "Glorioso Islands", "Greece", "Greenland", "Grenada", "Guadeloupe", "Guam", "Guatemala", "Guernsey", "Guinea", "Guinea-Bissau", "Guyana", "Haiti", "Heard Island and McDonald Islands", "Holy See (Vatican City)", "Honduras", "Hong Kong", "Howland Island", "Hungary", "Iceland", "India", "Indonesia", "Iran", "Iraq", "Ireland", "Ireland, Northern", "Israel", "Italy", "Jamaica", "Jan Mayen", "Japan", "Jarvis Island", "Jersey", "Johnston Atoll", "Jordan", "Juan de Nova Island", "Kazakhstan", "Kenya", "Kiribati", "Korea, North", "Korea, South", "Kuwait", "Kyrgyzstan", "Laos", "Latvia", "Lebanon", "Lesotho", "Liberia", "Libya", "Liechtenstein", "Lithuania", "Luxembourg", "Macau", "Macedonia, Former Yugoslav Republic of", "Madagascar", "Malawi", "Malaysia", "Maldives", "Mali", "Malta", "Man, Isle of", "Marshall Islands", "Martinique", "Mauritania", "Mauritius", "Mayotte", "Mexico", "Micronesia, Federated States of", "Midway Islands", "Moldova", "Monaco", "Mongolia", "Montserrat", "Morocco", "Mozambique", "Namibia", "Nauru", "Nepal", "Netherlands", "Netherlands Antilles", "New Caledonia", "New Zealand", "Nicaragua", "Niger", "Nigeria", "Niue", "Norfolk Island", "Northern Mariana Islands", "Norway", "Oman", "Pakistan", "Palau", "Panama", "Papua New Guinea", "Paraguay", "Peru", "Philippines", "Pitcaim Islands", "Poland", "Portugal", "Puerto Rico", "Qatar", "Reunion", "Romainia", "Russia", "Rwanda", "Saint Helena", "Saint Kitts and Nevis", "Saint Lucia", "Saint Pierre and Miquelon", "Saint Vincent and the Grenadines", "Samoa", "San Marino", "Sao Tome and Principe", "Saudi Arabia", "Scotland", "Senegal", "Seychelles", "Sierra Leone", "Singapore", "Slovakia", "Slovenia", "Solomon Islands", "Somalia", "South Africa", "South Georgia and South Sandwich Islands", "Spain", "Spratly Islands", "Sri Lanka", "Sudan", "Suriname", "Svalbard", "Swaziland", "Sweden", "Switzerland", "Syria", "Taiwan", "Tajikistan", "Tanzania", "Thailand", "Tobago", "Toga", "Tokelau", "Tonga", "Trinidad", "Tunisia", "Turkey", "Turkmenistan", "Tuvalu", "Uganda", "Ukraine", "United Arab Emirates", "United Kingdom", "Uruguay", "USA", "Uzbekistan", "Vanuatu", "Venezuela", "Vietnam", "Virgin Islands", "Wales", "Wallis and Futuna", "West Bank", "Western Sahara", "Yemen", "Yugoslavia", "Zambia", "Zimbabwe");

// States
var s_a = new Array();
s_a[0]="ACT|Queensland|New South Wales|Northern Territory|South Australia|Tasmania|Victoria|Western Australia";
s_a[1]="ACT|Queensland|New South Wales|Northern Territory|South Australia|Tasmania|Victoria|Western Australia";
...
function populateCountries(countryElementId, stateElementId){
	...
	countryElement.options[0] = new Option('Australia','-1');
...
var hrs_arr = new Array("00:00","24/7", "1 am", "2 am", "3 am", "4 am", "5 am", "6 am", "7 am", "8 am", "9 am", "10 am", "11 am", "12 pm", "1 pm", "2 pm", "3 pm", "4 pm", "5 pm", "6 pm", "7 pm", "8 pm", "9 pm", "10 pm", "11 pm", "12 am", "Till Late")

function populateHrsfrm(hrsfrmElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var hrsfrmElement = document.getElementById(hrsfrmElementId);
	hrsfrmElement.length=0;
	hrsfrmElement.options[0] = new Option('00:00','-1');
	
	
	var hrsfrmElement = document.getElementById(hrsfrmElementId);
	hrsfrmElement.selectedIndex = 0;
	for (var i=0; i<hrs_arr.length; i++) {
		hrsfrmElement.options[hrsfrmElement.length] = new Option(hrs_arr[i],hrs_arr[i]);
	}
...
function populateHrsto(hrstoElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var hrstoElement = document.getElementById(hrstoElementId);
	hrstoElement.length=0;
	hrstoElement.options[0] = new Option('00:00','-1');
	
	
	var hrstoElement = document.getElementById(hrstoElementId);
	hrstoElement.selectedIndex = 0;
	for (var i=0; i<hrs_arr.length; i++) {
		hrstoElement.options[hrstoElement.length] = new Option(hrs_arr[i],hrs_arr[i]);
	}

	
	
}
function populateHrsfrm(hrsfrmTueElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var hrsfrmElement = document.getElementById(hrsfrmTueElementId);
	hrsfrmElement.length=0;
	hrsfrmElement.options[0] = new Option('00:00','-1');
...
function populateHrsto(hrstoTueElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var hrstoElement = document.getElementById(hrstoTueElementId);
	hrstoElement.length=0;
	hrstoElement.options[0] = new Option('00:00','-1');
...
function populateHrsfrm(hrsfrmWedElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var hrsfrmElement = document.getElementById(hrsfrmWedElementId);
	hrsfrmElement.length=0;
	hrsfrmElement.options[0] = new Option('00:00','-1');
...
function populateHrsto(hrstoWedElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var hrstoElement = document.getElementById(hrstoWedElementId);
	hrstoElement.length=0;
	hrstoElement.options[0] = new Option('00:00','-1');
...
function populateHrsfrm(hrsfrmThursElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var hrsfrmElement = document.getElementById(hrsfrmThursElementId);
	hrsfrmElement.length=0;
	hrsfrmElement.options[0] = new Option('00:00','-1');
...
function populateHrsto(hrstoThursElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var hrstoElement = document.getElementById(hrstoThursElementId);
	hrstoElement.length=0;
	hrstoElement.options[0] = new Option('00:00','-1');
...
function populateHrsfrm(hrsfrmFriElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var hrsfrmElement = document.getElementById(hrsfrmFriElementId);
	hrsfrmElement.length=0;
	hrsfrmElement.options[0] = new Option('00:00','-1');
...
function populateHrsto(hrstoFriElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var hrstoElement = document.getElementById(hrstoFriElementId);
	hrstoElement.length=0;
	hrstoElement.options[0] = new Option('00:00','-1');
...
function populateHrsfrm(hrsfrmSatElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var hrsfrmElement = document.getElementById(hrsfrmSatElementId);
	hrsfrmElement.length=0;
	hrsfrmElement.options[0] = new Option('00:00','-1');
...
function populateHrsto(hrstoSatElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var hrstoElement = document.getElementById(hrstoSatElementId);
	hrstoElement.length=0;
	hrstoElement.options[0] = new Option('00:00','-1');
...
function populateholiHrsfrm(hrsfrmSunElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var hrsfrmElement = document.getElementById(hrsfrmSunElementId);
	hrsfrmElement.length=0;
	hrsfrmElement.options[0] = new Option('Closed','-1');
...
function populateholiHrsto(hrstoSunElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var hrstoElement = document.getElementById(hrstoSunElementId);
	hrstoElement.length=0;
	hrstoElement.options[0] = new Option('Closed','-1');
